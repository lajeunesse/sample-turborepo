...
!-- social icons -> a class="social-icon codepen" href="https://codepen.io/simeydotme" title="view
my codepens"> Made by Simey /a> a class="social-icon twitter" href="https://twitter.com/simeydotme">
...
/a> a class="social-icon github" href="https://github.com/simeydotme">
<svg viewBox="0 0 24 24">
	<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
	<path
